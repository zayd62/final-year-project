...
This GitHub repository [@fitzpatrickPaulfitzMlsql2020] is based on this GitHub repository [@naverNaverSqlova2020] which in turn is based on the paper by [@hwangComprehensiveExplorationWikiSQL]